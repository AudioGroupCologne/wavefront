            ...
            .show(ctx, |ui| {
                ...
                ui.columns(2, |columns| {
                    ...
                    columns[1].vertical_centered(|ui| {
                        ...
                        egui::Grid::new("experimental_grid")
                            .striped(true)
                            .num_columns(2)
                            .show(ui, |ui| {
                                ui.with_layout(Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    ToolType::Place(_) => {
                        egui::ComboBox::from_label("Select Object to Place")
                            ...
                            .show_ui(ui, |ui| {
                                ...
                                ui.selectable_value(&mut ui_state.cur_place_type, PlaceType::Source, "Source");
                                ui.selectable_value(&mut ui_state.cur_place_type, PlaceType::Mic, "Microphone");
                                ui.selectable_value(&mut ui_state.cur_place_type, PlaceType::RectWall, "Rectangle Wall");
                                ui.selectable_value(&mut ui_state.cur_place_type, PlaceType::CircWall, "Circular Wall");
                            });

                        if matches!(ui_state.cur_place_type, PlaceType::RectWall | PlaceType::CircWall) {
                            ui.add(
